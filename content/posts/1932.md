...
slug: gen-ju-er-cha-sou-suo-shu-de-xing-zhi-he-v8sv
author: endlesscheng
date: 2021-07-11T06:00:50Z
---
# 根据二叉搜索树的性质合并
 
> [原文链接](https://leetcode.cn/problems/merge-bsts-to-create-single-bst/solution/gen-ju-er-cha-sou-suo-shu-de-xing-zhi-he-v8sv)
```go
const mx int = 5e4 + 1
