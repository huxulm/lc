...
author: endlesscheng
date: 2022-04-30T16:08:54Z
---
# 两种做法：二分+BFS / 两次 BFS（Python/Java/C++/Go）
 
> [原文链接](https://leetcode.cn/problems/escape-the-spreading-fire/solution/er-fen-bfspythonjavacgo-by-endlesscheng-ypp1)
## 方法一：二分答案 + BFS
